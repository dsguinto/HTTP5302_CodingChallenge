  ...
  req.onreadystatechange = function () {
    ...
    if (req.readyState == 4 && req.status == 200) {
      ...
      for (var i = 1; i <= employeeDataLimit; i++) {
        ...
        var userNameValue = document.createTextNode(
        ...
        rolesArray.forEach(function () {
          ...
          //Checks colour associated to role. If hexcode of colour starts with # (indicating a likely dark colour), changes the font colour to white
          //Simple attempt at adjusting role colour text, more robust version for identifying light/dark colours can be implimented later.
          var roleColour = (role.style.backgroundColor = rolecolor);
          console.log(roleColour);
          if (
            parseInt(roleColour.charAt(1)) >= 0 &&
            parseInt(roleColour.charAt(1)) <= 9
          ) {
            rolesBlock.style.color = "white";
          }
